 ...
 *             @OA\Property(property="name", type="string", example="Running Shoes", description="Product name"),
 *             @OA\Property(property="price", type="number", format="float", example=99.99, description="Product price"),
 *             @OA\Property(property="description", type="string", example="Comfortable running shoes", description="Product description"),
 ...
 *         @OA\JsonContent(
 *             @OA\Property(property="name", type="string", example="Updated Running Shoes"),
...
Flight::route("PATCH /product/@id", function($id){
    ...
    Flight::json([
        ...
        'data' => Flight::product_service()->update($product, $id, 'id')
    ]);
});
