 ...
 * )
 */
Flight::route("GET /order_item", function(){
...
/**
 * @OA\Get(
 *     path="/order_item/order/{order_id}",
 *     tags={"order_items"},
 ...
 * )
 */
Flight::route("GET /order_item/order/@order_id", function($order_id){
...
Flight::route("PATCH /order_item/@id", function($id){
    ...
    Flight::json([
        ...
        'data'=>Flight::order_item_service()->update($data, $id, 'id')
    ]);
});
