 ...
 *                 @OA\Property(property="email", type="string", example="john456@example.com", description="User email address"),
...
Flight::route("POST /user", function(){
    ...
    // overwrite request so DAO gets correct data
    Flight::request()->data->setData($request);
