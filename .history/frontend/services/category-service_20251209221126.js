var CategoryService = {
    ...
    openEditModal: function (id) { RestClient.get("categories/" + id, function (response) { let c = response.data; $("#edit_category_id").val(c.category_id); $("#edit_name").val(c.name); $("#edit_description").val(c.description); new bootstrap.Modal(document.getElementById("editCategoryModal")).show(); }); },
