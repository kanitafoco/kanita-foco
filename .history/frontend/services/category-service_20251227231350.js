var CategoryService = {
    ...
    loadCategories: function () {
        RestClient.get("categories", function (response) {
            ...
            const data = response.data ?? response; // ✅ KLJUČNO
                    ...
                    render: function (row) {
                        return `
                          <button class="btn btn-warning btn-sm"
                            onclick="CategoryService.openEditModal(${row.category_id})">
                            Edit
                          </button>
                          <button class="btn btn-danger btn-sm"
                            onclick="CategoryService.openDeleteModal(${row.category_id})">
                            Delete
                          </button>
                        `;
                    }
            ...
            Utils.datatable("categories-table", columns, data);
        });
    },
    ...
    closeModal: function () {
        document.activeElement?.blur(); // ✅ FIX za aria-hidden
