...
class OrderItemService {
    ...
    private function validate_foreign_keys($data) {
        ...
        // provjeri ORDER samo ako postoji u istoj konekciji
        // ali ako tabela orders nema podatke, preskoči validaciju
        ...
        if ($count > 0) {
            ...
            if (!$order) {
                throw new Exception("Order with ID {$data['order_id']} does not exist (local DB).");
            }
        }
    
        // validacija PRODUCTA ostaje ista
