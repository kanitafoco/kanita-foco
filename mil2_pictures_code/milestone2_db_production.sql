...
--
-- Host: localhost    Database: milestone2_db_production
-- ------------------------------------------------------
...
CREATE TABLE `users` (
  ...
  `role` enum('customer','number') COLLATE utf8mb4_unicode_ci DEFAULT 'customer',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`user_id`),
...
--
-- Dumping events for database 'milestone2_db_production'
--

--
-- Dumping routines for database 'milestone2_db_production'
--
...
-- Dump completed on 2025-10-26 23:02:00
