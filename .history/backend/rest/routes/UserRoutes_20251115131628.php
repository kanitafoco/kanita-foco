 ...
 *     security={ {"ApiKey": {}} },
 *     @OA\Parameter(name="id", in="query", required=true, description="User ID.", @OA\Schema(type="integer"), example=1),
 *     @OA\Response(response=200, description="Fetched user by ID."),
 ...
 *     @OA\Response(response=200, description="Fetched individual user by ID."),
 ...
 *     security={ {"ApiKey": {}} },
 *     @OA\Parameter(name="email", in="path", required=true, description="Email address of the user.", @OA\Schema(type="string"), example="john@example.com"),
 *     @OA\Response(response=200, description="Fetched user by email."),
 *     @OA\Response(response=400, description="Invalid or missing email.")
 * )
 */
 ...
 *             @OA\Property(property="role", type="string", example="customer", description="User role")
 *         )
 *     ),
 *     @OA\Response(response=200, description="User has been added successfully."),
 *     @OA\Response(response=500, description="Internal server error.")
 * )
 */
...
Flight::route("PATCH /user/@id", function($id){
    ...
    Flight::json([
        ...
        'data' => Flight::user_service()->update($user, $id, 'user_id')
    ]);
});
